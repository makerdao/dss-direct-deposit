...
contract DssDirectDepositHub {
    ...
    */
    function exit(bytes32 ilk, address usr, uint256 wad) external lock {
        require(wad <= MAXINT256, "DssDirectDepositHub/overflow");
    ...
    */
    function cull(bytes32 ilk) external {
        ...
        require(ink <= MAXINT256, "DssDirectDepositHub/overflow");
        require(art <= MAXINT256, "DssDirectDepositHub/overflow");
